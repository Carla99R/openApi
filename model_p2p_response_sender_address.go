...
// P2pResponseSenderAddress Address of the sender in response.
type P2pResponseSenderAddress struct {
	// First line of the sender's address. Alphanumeric Special [a-zA-Z0-9 !\"#$%&'()*+,-./&#92;:;<=>?@[]_`{|}~ÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÑÒÓÔÕÖÙÚÛÜÝàáâãäåçèéêëìíîïñòóôõöùúûüýÿ], length: 1-50.
	...
	// The sender's city. Alphanumeric Special [a-zA-Z0-9 !\"#$%&'()*+,-./&#92;:;<=>?@[]_`{|}~ÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÑÒÓÔÕÖÙÚÛÜÝàáâãäåçèéêëìíîïñòóôõöùúûüýÿ], length: 1-25.
	City *string `json:"city,omitempty"`
	// The sender's province, state or territory, as an ISO 3166-2 uppercase alpha 2 or 3 character country subdivision code. For example, Missouri is MO.
	CountrySubdivision *string `json:"country_subdivision,omitempty"`
	// The sender's postal code. For USA, this is 5 digits or 5 digits hyphen 4 digits, for example '63368', '63368-5555'. For other regions, this is alphanumeric, length 1-10.
	PostalCode *string `json:"postal_code,omitempty"`
	// The sender's country as an ISO 3166-1 uppercase alpha-3 country code; see [Country and Currency Codes](https://developer.mastercard.com/mastercard-send-person-to-person/documentation/field-uris-codes/country-currency-codes/). For example, the United States of America is USA.
...
func (o P2pResponseSenderAddress) MarshalJSON() ([]byte, error) {
...
type NullableP2pResponseSenderAddress struct {
	value *P2pResponseSenderAddress
	isSet bool
}

func (v NullableP2pResponseSenderAddress) Get() *P2pResponseSenderAddress {
	return v.value
}

func (v *NullableP2pResponseSenderAddress) Set(val *P2pResponseSenderAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableP2pResponseSenderAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableP2pResponseSenderAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableP2pResponseSenderAddress(val *P2pResponseSenderAddress) *NullableP2pResponseSenderAddress {
	return &NullableP2pResponseSenderAddress{value: val, isSet: true}
}

func (v NullableP2pResponseSenderAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableP2pResponseSenderAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
