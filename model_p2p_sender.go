...
// P2pSender Information about the sender of the transaction.
type P2pSender struct {
	// The sender's first name. Alphanumeric Special [a-zA-Z0-9 !\"#$%&'()*+,-./&#92;:;<=>?@[]_`{|}~ÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÑÒÓÔÕÖÙÚÛÜÝàáâãäåçèéêëìíîïñòóôõöùúûüýÿ], length 1-40.
	...
	// The sender's last name. Alphanumeric Special [a-zA-Z0-9 !\"#$%&'()*+,-./&#92;:;<=>?@[]_`{|}~ÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÑÒÓÔÕÖÙÚÛÜÝàáâãäåçèéêëìíîïñòóôõöùúûüýÿ], length 1-40.
	...
	Address *P2pResponseSenderAddress `json:"address,omitempty"`
...
func (o *P2pSender) GetAddress() P2pResponseSenderAddress {
	if o == nil || o.Address == nil {
		var ret P2pResponseSenderAddress
		return ret
	}
	return *o.Address
}
...
// SetAddress gets a reference to the given P2pResponseSenderAddress and assigns it to the Address field.
...
func (o P2pSender) MarshalJSON() ([]byte, error) {
...
type NullableP2pSender struct {
	value *P2pSender
	isSet bool
}

func (v NullableP2pSender) Get() *P2pSender {
	return v.value
}

func (v *NullableP2pSender) Set(val *P2pSender) {
	v.value = val
	v.isSet = true
}

func (v NullableP2pSender) IsSet() bool {
	return v.isSet
}

func (v *NullableP2pSender) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableP2pSender(val *P2pSender) *NullableP2pSender {
	return &NullableP2pSender{value: val, isSet: true}
}

func (v NullableP2pSender) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableP2pSender) UnmarshalJSON(src []byte) error {
	v.isSet = true
