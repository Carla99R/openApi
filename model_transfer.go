...
type Transfer struct {
	...
	TransactionHistory *TransactionHistory    `json:"transaction_history,omitempty"`
	...
	// Original status of the transfer. One of APPROVED, DECLINED, UNKNOWN, ERROR, PENDING, CANCELLED. PENDING and CANCELLED are possible for non-card transactions (not applicable to card).
	OriginalStatus *string `json:"original_status,omitempty"`
	// Status of the transfer. One of APPROVED, UNKNOWN, PENDING, CANCELLED. PENDING and CANCELLED are possible for non-card transactions (not applicable to card). PENDING indicates the transaction is still in progress.
...
// SetTransactionHistory gets a reference to the given TransactionHistory and assigns it to the TransactionHistory field.
